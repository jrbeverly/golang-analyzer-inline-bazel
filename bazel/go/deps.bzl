...
def go_dependencies():
    ...
    go_repository(
        name = "com_github_blanchonvincent_ctxarg",
        importpath = "github.com/blanchonvincent/ctxarg",
        sum = "h1:HxxuKtftZd+C0s5bhYa5tsVD0lLPqcFAd1qRF3yNdug=",
        version = "v0.0.0-20190726074905-a05d037a0c36",
    )
